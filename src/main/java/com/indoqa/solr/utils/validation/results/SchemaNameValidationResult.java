...
public class SchemaNameValidationResult extends AbstractValidationResult {
    ...
    public SchemaNameValidationResult(String schemaName, String responseSchemaName) {
        if (!Objects.equals(schemaName, responseSchemaName)) {
            this.differentValue = DifferentValue.of(schemaName, responseSchemaName);
        }
    }
    ...
    public String getErrorMessage(int levelOfIndentation) {
        ...
        result.append("Schema name differ. ");
