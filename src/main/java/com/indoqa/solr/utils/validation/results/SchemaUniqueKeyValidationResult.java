...
public class SchemaUniqueKeyValidationResult extends AbstractValidationResult {

    private DifferentValue differentValue;

    public SchemaUniqueKeyValidationResult(String schemaUniqueKey, String responseSchemaUniqueKey) {
        if (!Objects.equals(schemaUniqueKey, responseSchemaUniqueKey)) {
            this.differentValue = DifferentValue.of(schemaUniqueKey, responseSchemaUniqueKey);
        }
    }
    ...
    public String getErrorMessage(int levelOfIndentation) {
        ...
        result.append("Schema uniqueKey differ. ");
